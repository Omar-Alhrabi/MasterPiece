...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="{{ route('tasks.index') }}" class="d-none d-sm-inline-block btn btn-sm btn-secondary shadow-sm">
            ...
            <form action="{{ route('tasks.store') }}" method="POST">
                ...
                @if(isset($selectedProject))
                    ...
                    <div class="alert alert-info">
                        Creating a task for project: <strong>{{ $selectedProject->name }}</strong>
                    </div>
                @endif
                ...
                <div class="row">
                    <div class="col-12 text-right">
                        @if(isset($selectedProject))
                            <a href="{{ route('projects.show', $selectedProject) }}" class="btn btn-secondary">Cancel</a>
                        @else
